...
public class SquareGUI extends JButton
{
	...
	public static ImageIcon getSquareImage(SquareGUI square)
	{
		...
		if(p != null) {
			...
			case WHITE_PAWN:
				return (whiteTile ?
					Constants.WPAWN_WTILE : Constants.WPAWN_BTILE);
			case WHITE_KNIGHT:
				return (whiteTile ?
					Constants.WKNIGHT_WTILE : Constants.WKNIGHT_BTILE);
			case WHITE_BISHOP:
				return (whiteTile ?
					Constants.WBISHOP_WTILE : Constants.WBISHOP_BTILE);
			case WHITE_ROOK:
				return (whiteTile ?
					Constants.WROOK_WTILE : Constants.WROOK_BTILE);
			case WHITE_QUEEN:
				return (whiteTile ?
					Constants.WQUEEN_WTILE : Constants.WQUEEN_BTILE);
			case WHITE_KING:
				return (whiteTile ?
					Constants.WKING_WTILE : Constants.WKING_BTILE);
			case BLACK_PAWN:
				return (whiteTile ?
					Constants.BPAWN_WTILE : Constants.BPAWN_BTILE);
			case BLACK_KNIGHT:
				return (whiteTile ?
					Constants.BKNIGHT_WTILE : Constants.BKNIGHT_BTILE);
			case BLACK_BISHOP:
				return (whiteTile ?
					Constants.BBISHOP_WTILE : Constants.BBISHOP_BTILE);
			case BLACK_ROOK:
				return (whiteTile ?
					Constants.BROOK_WTILE : Constants.BROOK_BTILE);
			case BLACK_QUEEN:
				return (whiteTile ?
					Constants.BQUEEN_WTILE : Constants.BQUEEN_BTILE);
			case BLACK_KING:
				return (whiteTile ?
	...
	private boolean shouldReset()
	{
		if
		(
			m_square.equals(Constants.WPAWN_MTILE)		||
			m_square.equals(Constants.WKNIGHT_MTILE)	||
			m_square.equals(Constants.WBISHOP_MTILE)	||
			m_square.equals(Constants.WROOK_MTILE)		||
			m_square.equals(Constants.WQUEEN_MTILE) 	||
			m_square.equals(Constants.WKING_MTILE) 		||
			m_square.equals(Constants.BPAWN_MTILE)		||
			m_square.equals(Constants.BKNIGHT_MTILE)	||
			m_square.equals(Constants.BBISHOP_MTILE)	||
			m_square.equals(Constants.BROOK_MTILE)		||
			m_square.equals(Constants.BQUEEN_MTILE) 	||
			m_square.equals(Constants.BKING_MTILE) 		||
		...
		(
			...
			m_square.equals(Constants.BKING_CTILE)
		)
		{
			return false;
		}
