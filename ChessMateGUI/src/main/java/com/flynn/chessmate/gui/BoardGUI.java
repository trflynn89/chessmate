...
public class BoardGUI implements ActionListener, MouseListener
{
	...
	public void createAndShowGUI()
	{
		JPanel panel = new JPanel(
			new TableLayout("cols=2 tileft=10 tiright=10 ileft=10"));
	...
	private JPanel createInfoPanel()
	{
		...
		scorePanel.add(new ImagePanel(
			Constants.WROOK_TRANSPARENT.getDescription(),
			Constants.TINY_PIECE_SIZE), "s");
		scorePanel.add(new ImagePanel(
		...
		scorePanel.add(new ImagePanel(
			Constants.BROOK_TRANSPARENT.getDescription(),
			Constants.TINY_PIECE_SIZE), "s"
		);
		scorePanel.add(new ImagePanel(
		...
		scorePanel.add(new ImagePanel(
			Constants.BPAWN_TRANSPARENT.getDescription(),
			Constants.TINY_PIECE_SIZE), "s"
		);
