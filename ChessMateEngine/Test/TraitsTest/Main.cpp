...
namespace
{
    ...
    template <typename T, Util::enable_if_all<Util::if_foo::disabled<T>>...>
    ...
    template <typename T, Util::enable_if_all<Util::if_string::disabled<T>>...>
    bool isString(const T &)
    {
        return false;
    }
    ...
    template <typename T, Util::enable_if_all<Util::if_ostream::disabled<T>>...>
    bool isStreamable(const T &)
    {
        return false;
    }
    ...
    template <typename T, Util::enable_if_all<Util::if_hash::disabled<T>>...>
    bool isHashable(const T &)
    {
        return false;
    }
    ...
    template <typename T,
        Util::enable_if_not_all<std::is_pointer<T>, std::is_pod<typename std::remove_pointer<T>::type>>...>
    bool isPodPointer(const T &)
    {
        return false;
    }
    ...
    template <typename T,
        Util::enable_if_none<std::is_pointer<T>, std::is_pod<typename std::remove_pointer<T>::type>>...>
    bool isPodOrPointer(const T &)
    {
        return false;
    }
