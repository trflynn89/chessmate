/**
 * Windows implementation of the SocketImpl interface.
 *
...
//=============================================================================
bool SocketImpl::Connect(string hostname, int port) const
{
...
//=============================================================================
unsigned int SocketImpl::Send(string msg) const
{
	bool ignore;
...
//=============================================================================
unsigned int SocketImpl::Send(string msg, bool &wouldBlock) const
{
	...
	while (keepSending)
	{
		...
		if (currSent > 0)
		{
			msg = msg.substr(currSent, string::npos);
			bytesSent += currSent;
